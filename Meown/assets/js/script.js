...
function valorNome() {
  ...
  function validaMensagem() {
    ...
    if (mensagem.value.length >= 100) {
      txtMensagem.innerHTML =
        'Sua Meownsagem é muito grande, digite no máximo 100 caracteres ❌';
  ...
  function enviar() {
    if (nomeOk == true && emailOk == true && mensagemOk == true) {
      alert('Meownsagem enviada com sucesso!');
    } else {
      alert('Preencha a Meownsagem corretamente antes de enviar...');
    }
  }
